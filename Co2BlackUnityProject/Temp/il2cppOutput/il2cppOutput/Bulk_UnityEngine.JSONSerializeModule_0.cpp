...
extern "C"  RuntimeObject * JsonUtility_FromJson_m1426440543 (RuntimeObject * __this /* static, unused */, String_t* ___json0, Type_t * ___type1, const RuntimeMethod* method)
{
	typedef RuntimeObject * (*JsonUtility_FromJson_m1426440543_ftn) (String_t*, Type_t *);
	static JsonUtility_FromJson_m1426440543_ftn _il2cpp_icall_func;
	if (!_il2cpp_icall_func)
	_il2cpp_icall_func = (JsonUtility_FromJson_m1426440543_ftn)il2cpp_codegen_resolve_icall ("UnityEngine.JsonUtility::FromJson(System.String,System.Type)");
